# Complete engineering tool taxonomy

Source-linked editorial browsing taxonomy. Ambiguous introductory-scope matches were individually reviewed; remaining assignments use explicit description-scope rules. Membership is not task suitability or solver qualification.

Version: `fdda226930e61c7f968566e1a6534571648db7b10973c24b82c95a7217434847`

## Computational Geometry and CAD Kernels (`geometry`)

| ID | Subcategory | Memberships |
| --- | --- | ---: |
...
## Radio Frequency and Electromagnetic Engineering (`rf-em`)
...
## Optical Engineering and Photonics (`optics`)
...
## Integrated Circuit Design and Semiconductor Devices (`eda-digital`)
...
## FPGA Design and Verification (`fpga`)
...
## Electrical Power Systems Engineering (`power`)
...
## Laboratory Automation and Instrumentation (`lab`)
...
## Building Energy and HVAC Engineering (`building-energy`)
...
## Water Resources and Environmental Modeling (`water`)
...
## Porous Media and Subsurface Flow (`porous-media`)
...
## Multiphysics Modeling and Simulation (`multiphysics`)
...
## Acoustics and Vibration Engineering (`acoustics`)
...
## Renewable Energy Engineering (`renewables`)
...
## Space Systems and Astronautical Engineering (`space`)
...
## Numerical Methods and Scientific Computing (`numerical`)
...
## Scientific Data Analysis and Statistics (`data-analysis`)
...
## Mesh Generation and Processing (`meshing`)
...
## Printed Circuit Board Design (`eda-pcb`)
...
## Control Systems and Dynamic Simulation (`controls`)
...
## Atomistic Modeling and Quantum Chemistry (`atomistic`)
...
## Thermodynamics and Thermophysical Properties (`thermophysical`)
...
## Rendering and Computer Graphics (`rendering`)
...
## Operations Research and Discrete-Event Simulation (`operations`)
...
## Experimental Data Analysis and Characterization (`experimental-analysis`)
...
## Scientific Imaging and Image Processing (`imaging`)
...
## Scientific Workflow and Computing Infrastructure (`workflow`)
...
## Geospatial Science and Geographic Information Systems (`geospatial`)
...
## Electrical Systems Design (`electrical-design`)
...
## Reliability and Safety Engineering (`reliability`)
...
## Metrology and Dimensional Inspection (`metrology`)
...
## Industrial Plant and Piping Design (`plant-design`)
...
## Infrastructure Operations and Asset Management (`infrastructure-operations`)
...
## Manufacturing Cost Estimation (`manufacturing-cost`)
...
## Cloud Engineering and Simulation Platforms (`cloud-platform`)
...
## Engineering Collaboration and Design Review (`collaboration`)
...
## Plasma Physics and Engineering (`plasma`)
...
## Quantum Many-Body and Open-System Simulation (`quantum-manybody`)
...
## Quantum Computing and Circuit Simulation (`quantum-computing`)
...
## Particle Accelerator and Beam Physics (`accelerator`)
...
## Fire and Process Safety Engineering (`fire-safety`)
...
## Solid Earth Sciences (`geoscience`)
...
## Microfluidic Engineering (`microfluidics`)
...
## Data Center Engineering (`data-center`)
...
## Mining and Mineral Processing (`mining`)
...
## Mechanical Systems and Machine Elements (`mechanical-systems`)
...
## Atmospheric Science and Meteorology (`atmospheric-science`)
...
## Embedded Software Engineering (`embedded-software`)
